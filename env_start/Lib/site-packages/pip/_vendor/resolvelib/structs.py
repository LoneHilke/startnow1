...
class _FactoryIterableView(object):
    """Wrap an iterator factory returned by `divernd_matches()`.
...
class _SequenceIterableView(object):
    """Wrap an iterable returned by divernd_matches().
...
def build_iter_view(matches):
    """Build an iterable view from the value returned by `divernd_matches()`."""
    if callable(matches):
