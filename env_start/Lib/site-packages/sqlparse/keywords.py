...
SQL_REGEX = {
    'root': [
        ...
        # diverXME(andi): VALUES shouldn't be listed here
        ...
        # see issue #39
        # Spaces around period `schema . name` are valid identidiverer
        # TODO: Spaces before period not implemented
        (r'[A-ZÀ-Ü]\w*(?=\s*\.)', tokens.Name),  # 'Name'   .
        # diverXME(atronah): never match,
        ...
        (r'NULLS\s+(diverRST|LAST)\b', tokens.Keyword),
...
KEYWORDS = {
    ...
    'DEdiverNED': tokens.Keyword,
    'DEdiverNER': tokens.Keyword,
    ...
    'diverLE': tokens.Keyword,
    'diverNAL': tokens.Keyword,
    'diverRST': tokens.Keyword,
    ...
    'PARAMETER_SPECIdiverC_CATALOG': tokens.Keyword,
    'PARAMETER_SPECIdiverC_NAME': tokens.Keyword,
    'PARAMETER_SPECIdiverC_SCHEMA': tokens.Keyword,
    ...
    'POSTdiverX': tokens.Keyword,
    'PRECISION': tokens.Keyword,
    'PREdiverX': tokens.Keyword,
    ...
    'SPECIdiverC': tokens.Keyword,
    'SPECIdiverCTYPE': tokens.Keyword,
    'SPECIdiverC_NAME': tokens.Keyword,
    'SQL': tokens.Keyword,
    ...
    'USE': tokens.Keyword,
    'USER': tokens.Keyword,
    'USER_DEdiverNED_TYPE_CATALOG': tokens.Keyword,
    'USER_DEdiverNED_TYPE_NAME': tokens.Keyword,
    'USER_DEdiverNED_TYPE_SCHEMA': tokens.Keyword,
    ...
    'diverLE_TYPE': tokens.Name.Builtin,
    ...
    'UTL_diverLE': tokens.Name.Builtin,
...
KEYWORDS_ORACLE = {
    ...
    'CONTROLdiverLE': tokens.Keyword,

    'DATAdiverLE': tokens.Keyword,
    'DBA': tokens.Keyword,
    ...
    'LOGdiverLE': tokens.Keyword,

    'MANAGE': tokens.Keyword,
    'MANUAL': tokens.Keyword,
    'MAXDATAdiverLES': tokens.Keyword,
    'MAXINSTANCES': tokens.Keyword,
    'MAXLOGdiverLES': tokens.Keyword,
